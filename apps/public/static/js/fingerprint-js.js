...
function M(e, n) {
    ...
    for (r = 0; r < a; r += 16)
        (l[0] =
            t[r + 4] | (t[r + 5] << 8) | (t[r + 6] << 16) | (t[r + 7] << 24)),
            (l[1] =
            ...
            switch (t.label) {
                case 0:
                    return (
                        ...
                        ((o = n.createDynamicsCompressor()).threshold.value =
                            -70),
                        (o.knee.value = 40),
                        (o.ratio.value = 12),
                        (o.attack.value = 0),
                    ...
                    switch (t.label) {
                        ...
                        case 1:
                            for (t.sent(), m = 0; m < U.length; m++)
                                (r[U[m]] = d[m].offsetWidth),
                                    (o[U[m]] = d[m].offsetHeight);
                            return [
                                2,
                                Q.filter(function (e) {
                                    return s(f[e]);
...
function Ge(e) {
    return M(
        (function (e) {
            for (
                var n = "", t = 0, r = Object.keys(e).sort();
                t < r.length;
                t++
            ) {
                var o = r[t],
...
var Xe = { load: je, hashComponents: Ge, componentsToDebugString: Fe },
    Pe = M;
export {
    Fe as componentsToDebugString,
    Xe as default,
    z as doesBrowserSuspendAudioContext,
    A as getFullscreenElement,
    _ as getUnstableAudioFingerprint,
